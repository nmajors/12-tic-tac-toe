...
//                 gameBoard[move.row][move.column] = players[playerIndex].letter;
//
...
//         consol.log(winningPlayer.name + " has won!");
//     } else {
